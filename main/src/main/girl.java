...
public class girl extends JPanel {
    ...
    public String wolf[] = {"wolf_cub.png"};
    public String wolf1[] = {"wolf_cub_1.png"};
    ...
    public void paintComponent(Graphics g) {
        ...
        if (next == false && end == false && die == false) {
            ...
            Image image_W = new ImageIcon(this.getClass().getResource(wolf1[0])).getImage();
            ...
            if (change <= 10) {
                ...
                if (x >= getWidth() + 10) {
                    ...
                    r3 = r.randW();
                    if (flower == true) {
                        g.drawImage(p.image_L_F, 0, getHeight() - 280 + y, this);
                    } else {
                        g.drawImage(p.image_L, 0, getHeight() - 280 + y, this);
                    }
                    x = 0;
                } else {
            ...
            if (((((getWidth() - 300) - x) <= 50 && ((getWidth() - 300) - x) >= 0) || (x - (getWidth() - 300)) >= 0 
                    && (x - (getWidth() - 300)) <= 50) && (change >= 4000) && flower == true) {
                this.next = true;
                return;
            }
            g.drawImage(p.imageS1, getWidth() / 2 - 50, 20, this);
        } else if (next == true && end == false && die == false) {
            Image image1 = new ImageIcon(this.getClass().getResource(bg[k])).getImage();
            g.drawImage(image1, 0, 0, getWidth(), getHeight(), this);
            Image image_W = new ImageIcon(this.getClass().getResource(wolf[0])).getImage();
            g.drawImage(image_W, r3, getHeight() - 280, this);
            if (change >= 4900) {
                g.drawImage(p.image, getWidth() - 300, getHeight() - 280 + y, this);
                change = 4900;
            } else if (check_Stop == 102 || check_Stop == 78 || check_Stop == 104 || check_Stop == 56) {
                ...
                if (x >= getWidth() + 10) {
                    r2 = r.rand1();
                    r3 = r.randW();
                    g.drawImage(p.image_L_M, 0, getHeight() - 280 + y, this);
                    x = 0;
                } else {
            ...
            if (next == true) {
                ...
                g.drawString("Total Money : " + 0, 495, 400);
            }
        }
    }
}
