...
public class girl_3 extends JPanel {
    ...
    public String wolf[] = {"wolf_jump.png", "wolf_test.png"};
    public String wolf1[] = {"wolf_jump_1.png", "wolf_test_1.png"};
    ...
    public void paintComponent(Graphics g) {
        ...
        if (next == false && end == false && die == false) {
            ...
            Image image_W = new ImageIcon(this.getClass().getResource(wolf1[r2])).getImage();
            ...
            g.drawImage(p.imageS3, getWidth() / 2 - 50, 20, this);
            ...
            if (next == true) {
                ...
                g.drawString("Total Money : " + g2.money, 495, 400);
            }
        }
    }
}
